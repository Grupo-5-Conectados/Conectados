      ...
      include: [
        {
          ...
          attributes: [],    // no necesitamos campos de slots aquí
          required: true     // INNER JOIN: solo servicios con slots libres
        },
        {
          model: Usuario,
          as: 'prestador',
    ...
    const servicio = await Servicio.findByPk(id, {
      include: [
        ...
        },
        {
          ...
          as: 'disponibilidades',
          where: { disponible: true },
          required: false   // LEFT JOIN: mostrar servicio incluso sin slots
        }
      ]
    });
